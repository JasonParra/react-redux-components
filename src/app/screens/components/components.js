		...
		return (
			<div className={Styles.container}>
				<div className={Styles.row}>
								...
								input1
									? {
											...
											onClick: (e) =>
												this.handleInputs({
													...e,
													target: { ...e.target, value: "", name: "search" },
												}),
									  }
									: false
							}
					...
					<div className={Styles.column}>
						<CustomButtom size="mini" positive>
							positive
						</CustomButtom>
						<CustomButtom size="small" negative>
							negative
						</CustomButtom>
				...
				<div className={Styles.row}>
					<div className={Styles.column}>
						<div>
							<CustomButtom noBorder icon={faList} onClick={() => this.handleDropdown()}>
								Dropdown
							</CustomButtom>
							<CustomDropdown
								open={openDropdown}
